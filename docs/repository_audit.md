<!-- CHANGELOG: updated 2026-03-21: normalized to English and added gameplay v2 implications appendix -->
...
> **Phase-3 canonical:** This audit describes the accepted baseline architecture for the Phase-3 production flow.
...
- Frontend currently contains progression logic, so it is not yet a thin client.
...
4. Puzzle authoring pipeline
   ...
   - Why misaligned: maintainability improves when content is externalized.
...
- Navigation variance: players can traverse room interactions in different orders.
...
- Add robust mapping from gameplay events to learning outcomes (attempt correctness, BKT changes, hint usage).
